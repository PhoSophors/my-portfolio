  ...
  return (
    <>
      <div id="contact" className="my-contact">
        <section className="#">
          <div className=" py-1 px-4 xl:h-screen md:h-full sm:h-full flex items-center mx-auto max-w-screen-xl lg:grid  lg:py-1 lg:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="reveal fade-left w-full  p-5 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Contact with one of our available wallet providers or create
                    a new one.
                  </p>
                  <ul className="my-4 space-y-3">
                    ...
                    <li>
                      <a
                        ...
                        target="blank"
                        className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white bg-white text-black"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-5 w-5"
                    ...
                    <li>
                      <a
                        href="https://twitter.com/PhoSophors"
                        target="blank"
                        className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
                      >
                        <svg
                ...
                {/* contact */}
                <div className="reveal fade-right w-full p-5 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
