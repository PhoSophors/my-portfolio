            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <div class="grid grid-cols-1 md:grid-cols-3 gap-4 ">
                <motion.div
                  ...
                  className=" p-10 border-dashed border-2 border-sky-500 border-gray-200  shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-yellow-700"
                >
