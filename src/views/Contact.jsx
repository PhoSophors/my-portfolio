            ...
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                  ...
                  <ul class="my-4 space-y-3">
                    ...
                    <li>
                      <a
                        ...
                        target="blank"
                        class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white bg-white text-black"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-5 w-5"
                ...
                <div class="reveal fade-right w-full p-5 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <div class=" items-center justify-center mx-auto  gap-16 py-1 px-4 ">
                    <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                      {/* <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">01. About Me</h2> */}
                      <p class="mb-4">
